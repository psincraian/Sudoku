...
import propias.dominio.clases.ErrorUserEntry;
import propias.dominio.clases.Usuari;
...
public class CntrlCreateUser {
	 ...
	 * 
	 */
	public CntrlCreateUser (String nom, String pass1, String pass2){
		this.nom = nom;
		this.pass1 = pass1;
		this.pass2 = pass2;
	}
