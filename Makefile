all:
	...
	javac -encoding iso-8859-1 ./common/*.java ./propias/dominio/clases/*.java ./propias/dominio/controladores/*.java ./propias/persistencia/*.java ./propias/presentacion/*.java main.java ./propias/dominio/controladores/generator/*.java ./propias/dominio/controladores/generator/dlx/*.java
